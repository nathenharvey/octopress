...
At the inaugural [#ChefConf](http://chefconf.opscode.com) there were many sessions that included information about many companies' approach to testing.  Here's a quick list of some of the sessions with links to the slides and/or video of each:
